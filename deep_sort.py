...
flags.DEFINE_string("video", "D:/HUST/dev/py/RAT_DETECTION/data_chua_label/test/Y2meta.app-Big Rat shooting 2023 __ Night hunting rats with thermal scope __ shooting rats in farm at night.mp4", "Path to input video or webcam index (0)")
